...
describe("The updateList query", () => {
    it("doesn't allow updating another users list", async () => {
        const result = await updateList(db, {name: "test"},"9qOhDu7YxkvvO7YZuI6KIPZVcnzBfExM","c6037ab1-4c29-4cf2-939e-1a8151743f6b")
...
describe("The deleteList query", () => {
    it("doesn't allow deleting another users list", async () => {
        const result = await deleteList(db,"c6037ab1-4c29-4cf2-939e-1a8151743f6b", "1RIhcRx425vtBSDJt1exA2tswZcFtsTM")
