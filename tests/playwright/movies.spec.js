...
test.describe("the index route", () => {
  test.beforeEach(async ({ page }) => {
    ...
    await expect(page.getByRole('button', { name: 'Your region' })).not.toBeVisible()
  })
  ...
  test.describe("filtering", () => {
    ...
    test("by keyword", async ({ page }) => {
      ...
      await expect(page.getByText("los siete pecados").first()).not.toBeVisible()
      await page.getByText("Submit").click()
  ...
  test.describe("Saving searches", () => {
    ...
    test("saving a search", async ({ page }) => {
      ...
      await page.getByRole("button", { name: "Close", exact: true }).click()
      await page.getByText("Filters").click()
      await expect(page.getByRole('combobox', { name: 'Languages' })).toHaveText("Spanish")
      ...
      await expect(page.getByLabel("TMDB Vote Count minimum")).toHaveValue("100")
    })
