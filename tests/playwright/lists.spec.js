...
test.describe("as a logged in user", () => {
  ...
  test.describe("lists", () => {
    ...
    test("Removing media from a list", async ({ page }) => {
      await page.getByText("My updated list").click()
      await page.getByAltText("The Matrix Revolutions").click({ button: "right" })
    ...
    test("Adding a collection to a list", async ({ page }) => {
      ...
      await page.goto("/lists")
      await page.getByText("My updated list").click()
      await expect(page.getByAltText("The Lord of the Rings: The Fellowship of the Ring")).toBeVisible()
      await expect(page.getByAltText("The Lord of the Rings: The Two Towers")).toBeVisible()
      await expect(page.getByAltText("The Lord of the Rings: The Return of the King")).toBeVisible()
  ...
  test.describe("list filters", () => {
    ...
    test("filtering by genre", async ({ page }) => {
      ...
      await page.getByText("Submit").click()
      await expect(page.getByAltText("Dunkirk")).toBeVisible()
      await expect(page.getByAltText("All Quiet on the Western Front")).toBeVisible()
    ...
    test("filtering by release year", async ({ page }) => {
      ...
      await page.getByText("Submit").click()
      await expect(page.getByAltText("The Super Mario Bros. Movie")).toBeVisible()
