...
import { genresToMedia, likesToReviews, media, networks, networksToMedia, people, peopleToMedia, reviews, user } from "../../db/schema";
import { alias } from "drizzle-orm/sqlite-core";

export function getMediaReviews(db, userId, mediaId, sort, offset, itemsPerPage) {
...
export function insertPersonMedia({ db, personId, mediaId, isDirector = false, isCreator = false }) {
    return db.insert(peopleToMedia)
    .values({
        personId: personId,
        mediaId: mediaId,
...
export function insertGenreMedia(db, genreId, mediaId) {
    return db.insert(genresToMedia)
    .values({
        genreId: genreId,
        mediaId: mediaId,
    })
...
export function insertNetworkMedia(db, networkId, mediaId) {
    return db.insert(networksToMedia)
    .values({
        networkId: networkId,
        mediaId: mediaId,
    })
